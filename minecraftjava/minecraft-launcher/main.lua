...
local fileMappings = {
    ["skyR36S"] = "skyR36S.start",
    ["Vanilla v1.7.10"] = "1.7.10.start",
    ["Vanilla v1.9.4"] = "1.9.4.start",
    ["Forge v1.9.4"] = "1.9.4-Forge.start",
...
function populateMenu()
    ...
    if love.filesystem.getInfo("forge-1.9.4-sky-key") then
        table.insert(menu, "skyR36S")
    end
	if love.filesystem.getInfo("vanilla-1.9.4-key") then
        table.insert(menu, "Vanilla v1.9.4")
    end
    ...
    if love.filesystem.getInfo("forge-1.9.4-key") then
        table.insert(menu, "Forge v1.9.4")
    end
