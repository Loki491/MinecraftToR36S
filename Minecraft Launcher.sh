...
check_versions() {
	...
	# Vanilla 1.7
    if [ -f "$GAMEDIR/.minecraft/versions/1.9.4/1.9.4.jar" ]; then
        touch "$GAMEDIR/minecraft-launcher/vanilla-1.9.4-key"
    else
        rm -f "$GAMEDIR/minecraft-launcher/vanilla-1.9.4-key"
    fi
	# Forge 1.9.4
    if [ -f "$GAMEDIR/.minecraft/versions/1.9.4-forge/1.9.4-forge.jar" ] || [ -f "$GAMEDIR/.minecraft/versions/1.9.4-forge1.9.4-12.17.0.2317-1.9.4/1.9.4-forge1.9.4-12.17.0.2317-1.9.4.jar" ]; then
        touch "$GAMEDIR/minecraft-launcher/forge-1.9.4-key"
    else
